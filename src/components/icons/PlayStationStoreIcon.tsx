...
export default function PlayStationStoreIcon(props: SVGProps<SVGSVGElement>) {
    return (
        <svg
            id="Layer_1"
            data-name="Layer 1"
