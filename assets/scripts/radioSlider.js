  ...
  document.querySelectorAll("[data-radios]").forEach(container => {
    ...
    const radioData = {
      ...
      "HEAD_RADIO_III": {
        ...
        image: "../assets/images/radios/III/headradio.webp", audio: "https://viceclub.s3.us-east-1.amazonaws.com/III/Head+Radio.mp3",
        dj: "Michael Hunt",
      ...
      "DOUBLE_CLEF_III": {
        ...
        audio: "https://viceclub.s3.us-east-1.amazonaws.com/III/Double+Clef.mp3",
      ...
      "FLASHBACK_95.6": {
        ...
        list: ["Debbie Harry - Rush Rush", "Elizabeth Daily - Shake It Up", "Paul Engemann - Scarface (Push It To The Limit)", "Amy Holland - She's On Fire", "Elizabeth Daily - I'm Hot Tonight"],
        songs: [
          {title: "Rush Rush", artist: "Debbie Harry", start: "4", end: "195"},
          {title: "Shake It Up", artist: "Elizabeth Daily", start: "250", end: "441"},
          {title: "Scarface (Push It To The Limit)", artist: "Paul Engemann", start: "526", end: "672"},
          {title: "She's On Fire", artist: "Amy Holland", start: "678", end: "885"},
          {title: "I'm Hot Tonight", artist: "Elizabeth Daily", start: "939", end: "1107"},
        ]
      },
      ...
      "FEVER_VC": {
        ...
        dj: 'Oliver Biscuit',
        genre: "Disco/Funk",
        list: ["The Whispers - And The Beat Goes On", "Fat Larry's Band - Act Like You Know", "Oliver Cheatham - Get Down Saturday Night", "The Pointer Sisters - Automatic", "René & Angela - I'll Be Good", "Mary Jane Girls - All Night Long", "Rick James - Ghetto Life", "Michael Jackson - Wanna Be Startin' Somethin'*", "Evelyn \"Champagne\" King - Shame", "Teena Marie - Behind The Groove", "Mtume - Juicy Fruit", "Kool & The Gang - Summer Madness", "Indeep - Last Night a DJ Saved My Life"],
        songs: []
      },
      "V-ROCK_VC": {
      ...
      "ESPANTOSO_VC": {
        ...
        list: ["Cachao - A gozar con mi combo", "Alpha Banditos - The Bull Is Wrong*", "Tres Apenas Como Eso - Yo te miré*", "Eumir Deodato - Latín Flute", "Mongo Santamaría - Mama Papa Tu", "Mongo Santamaría - Me and You Baby (Picao y Tostao)", "Machito y su Orquesta Afrocubana - Mambo, mucho mambo", "Unaesta - La vida es una lenteja*", "Lonnie Liston Smith - Expansions", "Irakere - Añunga Ñunga", "Eumir Deodato - Super Strut", "Xavier Cugat u Su Gran Orquesta - Jamay", "Benny Moré - Maracaibo Oriental", "Tito Puente - Mambo gozón"],
        songs: []
      },
      "EMOTION_VC": {
        ...
        list: ["Foreigner - Waiting For A Girl Like You", "Kate Bush - Wow*", "Squeeze - Tempted", "REO Speedwagon - Keep On Loving You", "Cutting Crew - (I Just) Died in Your Arms", "Roxy Music - More Than This", "Toto - Africa", "Mr. Mister - Broken Wings", "John Waite - Missing You", "Jan Hammer - Crockett's Theme", "Night Ranger - Sister Christian", "Luther Vandross - Never Too Much"],
        songs: []
      },
      "WAVE_VC": {
        ...
        dj: 'Adam First',
        genre: "New Wave",
        list: ["Frankie Goes To Hollywood - Two Tribes", "Sigue Sigue Sputnik - Love Missile F1-11", "Gary Numan - Cars", "The Human League - (Keep Feeling) Fascination", "Blondie - Atomic", "Nena - 99 Luftballons", "Kim Wilde - Kids In America", "Tears For Fears - Pale Shelter", "Corey Hart - Sunglasses At Night", "ABC - Poison Arrow", "A Flock Of Seagulls - I Ran (So Far Away)", "The Psychedelic Furs - Love My Way", "Animotion - Obsession", "Spandau Ballet - Gold", "Thomas Dolby - Hyperactive!", "Romeo Void - Never Say Never"],
        songs: []
      },
      //GTA SA
      "PLAYBACK": {
      ...
      "K-ROSE": {
        ...
        list: ["Jerry Reed - Amos Moses", "Conway Twitty & Loretta Lynn - Louisiana Woman, Mississippi Man", "Hank Williams With His Drifting Cowboys - Hey Good Lookin'", "Juice Newton - Queen of Hearts", "The Statler Brothers - New York City", "Asleep At The Wheel - The Letter That Johnny Walker Read", "The Desert Rose Band - One Step Forward", "Willie Nelson - Crazy", "Patsy Cline - Three Cigarettes In An Ashtray", "The Statler Brothers - Bed Of Roses", "Mickey Gilley - Make The World Go Away", "Ed Bruce - Mamas Don't Let Your Babies Grow Up To Be Cowboys", "Merle Haggard And The Strangers - Always Wanting You", "Whitey Shafer - All My Ex's Live In Texas", "Eddie Rabbitt - I Love A Rainy Night"],
        songs: []
      },
      "K-DST": {
        ...
        genre: "Rock",
        list: ["Foghat - Slow Ride", "Creedance Clearwater Revival - Green River", "Heart - Barracuda", "Kiss - Strutter", "Toto - Hold The Line", "Rod Stewart - Young Turks", "Tom Petty - Running Down a Dream*", "Joe Cocker - Woman to Woman*", "Humble Pie - Get Down To It", "Grand Funk Railroad - Some Kind Of Wonderful", "Lynyrd Skynyrd - Free Bird", "America - A Horse With No Name", "The Who - Eminence Front", "Boston - Smokin'", "David Bowie - Somebody Up There Likes Me", "Eddie Money - Two Tickets to Paradise", "Billy Idol - White Wedding"],
        songs: []
      },
      "BOUNCE_FM": {
        ...
        dj: 'The Funktipus',
        genre: "Disco/Funk",
        list: ["Zapp - I Can Make You Dance", "Kool & The Gang - Hollywood Swinging", "The Ohio Players - Love Rollercoaster", "Rick James - Cold Blooded", "Maze - Twilight", "The Fatback Band - Yum Yum (Gimme Some)*", "The Isley Brothers - Between The Sheets", "Ronnie Hudson & The Street People - West Coast Poplock", "Lakeside - Fantastic Voyage", "George Clinton - Loopzilla", "Dazz Band - Let it Whip", "Cameo - Candy", "MFSB (ft. The Three Degrees) - Love Is The Message (Part 2)", "The Ohio Players - Funky Worm", "Johnny Harris - Odyssey", "Roy Ayers - Running Away*", "The Gap Band - You Dropped A Bomb On Me*"],
        songs: []
      },
      "SF-UR": {
        ...
        list: ["Jomamda - Make My Body Rock (Feel It) (The Basic Mix)", "808 State - Pacific-202", "The Todd Jerry Project - Weekend (Club Version)", "The Night Writers (ft. Ricky Dillard) - Let The Music (Use You)", "Marshall Jefferson - Move Your Body", "Maurice - This Is Acid (A New Dance Craze) (K & T Mix)", "Mr. Fingers - Can You Feel It (Chuck D. Mix)", "A Guy Called Gerald - Voodoo Ray", "Cultural Vibe - Vibe - Ma Foom Bey", "Ce Ce Rogers - Someday (Club Mix)", "Robert Owens - I'll Be Your Friend (Original Def Mix)", "Frankie Knuckles (ft. Jamie Principle) - Your Love", "Joe Smooth (ft. Anthony Thomas - Promised Land (Original Mix)", "The 28th Street Crew - I Need A Rhythm", "Raze - Break 4 Love", "Fallout - The Morning After (Sunrise Mix)"],
        songs: []
      },
    };
    ...
    function updateRadio() {
      ...
      radioName.textContent = radioData[currentRadio]?.displayName || currentRadio;
    ...
    function playRadio(name) {
      ...
      if (!data || !data.audio) {
        audio.pause();
        document.getElementById("songTitle").textContent = "Sin canción en reproducción";
      ...
      if (songs && songs.length > 0) {
        ...
        document.getElementById("artistName").textContent = songs[currentSongIndex].artist;
        renderSongList(songs, currentSongIndex);

      } else {
        document.getElementById("songTitle").textContent = data.list[0] || "No hay canciones disponibles";
        document.getElementById("artistName").textContent = "";
        document.getElementById("currentTime").textContent = "0:00";
        document.getElementById("totalTime").textContent = "0:00";
        document.getElementById("currentBar").style.width = "0%";
    ...
    fullProgressBar.addEventListener('click', (e) => {
        ...
        if (songs && songs.length > 0) {
            ...
            for (let i = 0; i < songs.length; i++) {
                if (timeToSeek >= Number(songs[i].start) && timeToSeek < Number(songs[i].end)) {
                    foundSongIndex = i;
                    break;
                }
            }
